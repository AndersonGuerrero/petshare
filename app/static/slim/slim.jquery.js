...
var Slim = (function () {
    ...
    _createClass(Slim, [{
                ...
                _this17._loadCanvas(image, function () {
                    ...
                    var animation = {
                        ...
                        complete: function complete() {
                            ...
                            if (callback) {
                                $(_this17._element).find('.slim-status .slim-label').html('Seleccione su imagen aquí.')
        ...
        value: function _loadCanvas(image, ready) {
            ...
            // store raw data
            $(this._input).attr('required', false)
        ...
        value: function _doRemove() {
            ...
            if (this._isRequired) {
              ...
              $(this._input).attr('required', true)
            }
    ...
    function addTojQuery(endpoint) {
        $.fn[scope + (endpoint === 'create' ? '' : capitalizeFirstLetter(endpoint))] = function() {
            ...
            if (arguments[0] == 'instance') {
                return Slim[endpoint].apply(Slim[endpoint], this);
            } else {
